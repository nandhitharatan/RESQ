...
const T = {
  en:{ welcome:"What happened?", sub:"Select your injury below. We'll guide you step by step, calmly.", injuryLabel:"Select Injury", tapSpeak:"Tap to Speak", readAloud:"Read aloud", nextStep:"Done → Next Step", allDone:"✅ All Done!", sevTitle:"How bad is it?", sevSub:"Answer these quick questions so we can guide you.", sevCheck:"Check Severity", doneTitle:"You handled it! 💪", doneSub:"You completed all first aid steps. You did great under pressure. If symptoms worsen, visit a hospital." },
  te:{ welcome:"ఏమి జరిగింది?", sub:"దిగువ మీ గాయాన్ని ఎంచుకోండి. మేము దశ దశగా మీకు సహాయం చేస్తాము.", injuryLabel:"గాయాన్ని ఎంచుకోండి", tapSpeak:"మాట్లాడటానికి నొక్కండి", readAloud:"చదివి వినిపించు", nextStep:"తదుపరి దశ →", allDone:"✅ అన్నీ పూర్తయ్యాయి!", sevTitle:"ఎంత తీవ్రంగా ఉంది?", sevSub:"మేము మీకు సహాయం చేయడానికి కొన్ని ప్రశ్నలు అడుగుతాము.", sevCheck:"తీవ్రత తనిఖీ చేయండి", doneTitle:"మీరు చేశారు! 💪", doneSub:"అన్ని ప్రాథమిక చికిత్స దశలు పూర్తయ్యాయి. లక్షణాలు తీవ్రమైతే వైద్యుడిని సంప్రదించండి." },
  hi:{ welcome:"क्या हुआ?", sub:"नीचे अपनी चोट चुनें। हम आपको कदम दर कदम मार्गदर्शन करेंगे।", injuryLabel:"चोट चुनें", tapSpeak:"बोलने के लिए टैप करें", readAloud:"ज़ोर से पढ़ें", nextStep:"हो गया → अगला", allDone:"✅ सब हो गया!", sevTitle:"कितनी गंभीर है?", sevSub:"हम आपकी मदद के लिए कुछ सवाल पूछेंगे।", sevCheck:"गंभीरता जांचें", doneTitle:"आपने कर दिया! 💪", doneSub:"सभी प्राथमिक चिकित्सा चरण पूरे हो गए। यदि लक्षण बिगड़ें तो डॉक्टर से मिलें।" }
};
